...
test('GET /this/page/is/hidden/behind/an/incredibly/high/paywall/that/could/only/be/unlocked/by/sending/1btc-to-us', { signal: AbortSignal.timeout(timeout) }, async () => {
  await runner
    .createScan({
      tests: ['csrf', 'unvalidated_redirect', 'xss', 'sqli', 'open_database', 'secret_tokens', 'osi', 'ssrf', 'lfi', 'rfi', 'jwt', 'bopla', 'id_enumeration', 'improper_asset_management', 'insecure_tls_configuration', 'proto_pollution', 'xxe'],
